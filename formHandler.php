...
if ($xml) {
 ...
 if(!empty(strval($data->children($ns['D'])->ET))){ $_SESSION["error"] = 'IČ firmy nebylo nalezeno';  header('Location: https://vast-garden-09239.herokuapp.com/?orderBy=published&page=1'); die; }
